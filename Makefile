...
# PSGrade source files
PSGRADE_SRC = src


# Path to the LUFA library
LUFA_PATH = $(PSGRADE_SRC)/lufa-lib/trunk
...
SRC = $(PSGRADE_SRC)/psgrade.c $(PSGRADE_SRC)/sha1.c $(PSGRADE_SRC)/hmac.c $(LUFA_SRC_USB)
